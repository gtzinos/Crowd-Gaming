...
-- Sat 27 Feb 2016 12:46:01 PM EET
...
CREATE TABLE IF NOT EXISTS `quizapp`.`QuestionnaireParticipation` (
  ...
  PRIMARY KEY (`user_id`, `questionnaire_id`, `participation_type`),
...
INSERT INTO `quizapp`.`AccessLevel` (`id`, `name`, `updated`) VALUES (-3, 'Banned', 'CURRENT_TIMESTAMP');
INSERT INTO `quizapp`.`AccessLevel` (`id`, `name`, `updated`) VALUES (-2, 'Deleted', 'CURRENT_TIMESTAMP');
INSERT INTO `quizapp`.`AccessLevel` (`id`, `name`, `updated`) VALUES (-1, 'Inactive', 'CURRENT_TIMESTAMP');
