...
-- -----------------------------------------------------
-- Table `quizapp`.`ActivationLink`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `quizapp`.`ActivationLink` ;

CREATE TABLE IF NOT EXISTS `quizapp`.`ActivationLink` (
  `user_id` INT NOT NULL COMMENT '',
  `activation_parameter` VARCHAR(45) NULL COMMENT '',
  PRIMARY KEY (`user_id`)  COMMENT '',
  CONSTRAINT `actiontionlink_user_fk`
    FOREIGN KEY (`user_id`)
    REFERENCES `quizapp`.`User` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
