...
-- Mon 18 Apr 2016 08:47:20 PM EEST
...
CREATE TABLE IF NOT EXISTS `quizapp`.`QuestionGroup` (
  ...
  `radius` INT NOT NULL COMMENT 'Deviation longitude from location longitude ',
...
CREATE TABLE IF NOT EXISTS `quizapp`.`UserAnswer` (
  ...
  `latitude` DOUBLE NOT NULL COMMENT 'user altitude when he answer the question',
  `longitude` DOUBLE NOT NULL COMMENT 'user longitude he answer the question',
