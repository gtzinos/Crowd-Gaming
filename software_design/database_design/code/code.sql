...
CREATE TABLE IF NOT EXISTS `quizapp`.`QuestionGroups` (
  ...
  `creator` INT NOT NULL COMMENT 'Question Group creator',
...
CREATE TABLE IF NOT EXISTS `quizapp`.`Questions` (
  ...
  `creator` INT NOT NULL COMMENT 'user creator id',
  ...
  INDEX `uid_idx` (`creator` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `quizapp`.`Answers` (
  ...
  `creator` INT NOT NULL COMMENT 'user who update last time this answer',
  ...
  INDEX `qid_idx` (`qid` ASC)  COMMENT '',
  INDEX `user_updated_last_time_this_answer_idx` (`creator` ASC)  COMMENT '',
  PRIMARY KEY (`id`)  COMMENT '',
