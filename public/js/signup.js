			...
			*/
			else
			{
				 ...
				 */
				 ...
				 {
				 	response_message += "<div class='alert alert-danger'>Password length must be 8 - 50 characters.</div>";
				 }
				 /*
				 ...
				 */
				 ...
				 {
				  response_message += "<div class='alert alert-danger'>You must accept our licence.</div>";
				 }
				 /*
				 ...
				 */
				 ...
				 /*
				 	if(xmlHttp.responseText.localeCompare("") == 0)
					{
						...
						mail("to","From","response SIGNUP",xmlHttp.responseText);
						response_message = "Important response. Contact with one admin!";
					}
				 */
				 ...
				 */
			 	 $("#signup-response").show();
				 $("#signup-response").html(response_message);
