        ...
        if(minutes_left > 0)
        {
            ...
            */
            ...
            out += "<div class='visible-xs col-xs-offset-5 col-xs-7'>" +
                "<div style='font-size:15px' class='list-group-item-heading'> <div class='progress-bar progress-bar-striped progress-bar-info' role='progressbar' style='width:100%'>" + display + "</div></div>" +
              "</div>" +
              ...
              "<div class='row'>" +
                ...
                "</div>" +
                  "<div class='col-xs-offset-5 col-xs-7 col-sm-offset-4 col-sm-3 col-md-2'>" +
                    "<button type='button' class='btn btn-success' disabled onclick=\"handleQuestionnaireParticipationRequest(" + data.questionnaire[i]['id'] + ",'accept')\"><span class='fa fa-play'> Play</span></button> " +
                  "</div>" +
              "</div>" +
          "</div>";
       }
