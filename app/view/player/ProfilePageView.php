    ...
    <div class="form-group has-feedback">
     ...
     <div class="form-group has-feedback">
       ...
       <div class="input-group col-xs-7" data-validate="length" data-length="8">
              ...
              <span id="password-new-response"></span>
       </div>
     </div>
     <!-- Repeat Password repeat Field -->
     <div class="form-group has-feedback">
       <div class="col-xs-2">
              <!--  <label class="control-label" for="pwd">Password:</label> -->
              <span class="text-center"><i class="glyphicon glyphicon-lock bigicon"></i></span>
       </div>
       <div class="input-group col-xs-7" data-validate="length" data-length="8" data-equal="profile-new-password">
              <input type="password" class="form-control" id="profile-repeat-password" placeholder="Repeat Password (Optional)" />
              <span id="password-repeat-response"></span>
       </div>
     </div>
     <!-- First Name Field -->
     <div class="form-group has-feedback">
