  ...
  <div class="container-fluid">
    <form class="form-horizontal" id="profile-form">
         ...
         <div class="form-group has-feedback">
             ...
             <div class="col-xs-12 col-sm-offset-1 col-sm-9 col-md-offset-0 col-md-6 gt-input-group" data-validate="email">
         ...
         <div class="form-group has-feedback">
             ...
             <div class="col-xs-12 col-sm-offset-1 col-sm-9 col-md-offset-0 col-md-6 gt-input-group" data-validate="length" data-length="8">
         ...
         <div class="form-group has-feedback">
             ...
             <div class="col-xs-12 col-sm-offset-1 col-sm-9 col-md-offset-0 col-md-6 gt-input-group" data-validate="length" data-length="8" data-equal="profile-new-password">
         ...
         <div class="form-group has-feedback">
             ...
             <div class="col-xs-12 col-sm-offset-1 col-sm-9 col-md-offset-0 col-md-6 gt-input-group" data-validate="length" data-length="2">
         ...
         <div class="form-group has-feedback">
             ...
             <div class="col-xs-12 col-sm-offset-1 col-sm-9 col-md-offset-0 col-md-6 gt-input-group" data-validate="length" data-length="3">
         ...
         <div class="form-group has-feedback">
             ...
             <div class="col-xs-12 col-sm-offset-1 col-sm-9 col-md-offset-0 col-md-6 gt-input-group" data-validate="length" data-length="5">
         ...
         <div class="form-group has-feedback">
             ...
             <div class="col-xs-12 col-sm-offset-1 col-sm-9 col-md-offset-0 col-md-6 gt-input-group" data-validate="phone">
         ...
         <div class="form-group">
            ...
            <div class="visible-xs col-xs-12" >
              <button type="button" style="width:100%" form="profile-form" class="btn btn-primary btn-md gt-submit" onclick="confirmPassword('profileUpdate')">Update Now</button>
            </div>
            <div class="hidden-xs col-xs-5 col-sm-2 col-md-3">
              <button type="button" class="btn btn-danger btn-md" onclick="confirmPassword('deleteAccount')">Delete Account</button>
            </div>
            <div class="visible-xs col-xs-12" style="margin-top:2%">
              <button type="button" style="width:100%" class="btn btn-danger btn-md" onclick="confirmPassword('deleteAccount')">Delete Account</button>
            </div>
         </div>
   </form>
 </div>
