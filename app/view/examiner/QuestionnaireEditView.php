          ...
          <form method="POST" id="edit-questionnaire-form" class="form-horizontal" action="return false">
              ...
              <div class="form-group has-feedback">
                  ...
                  <div class="col-xs-12 col-sm-8 gt-input-group" data-validate="length" data-length="2">
                     <input class="form-control" value="<?php echo $questionnaire->getName() ?>" data-toggle="tooltip" gt-error-message="Must contain at least 2 characters" id="questionnaire-name" type="text" maxlength="255" placeholder="Questionnaire name (Required)" required>
