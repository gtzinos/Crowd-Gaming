<?php
	...
	*/
	...
	define_page('Informations', 'info' ,'Public/Info/InfoPageController.php' ,$_USER_LEVEL["GUEST"] );
	define_page('Contact Us', 'contact' ,'Public/Contact/ContactPageController.php' ,$_USER_LEVEL["GUEST"] );
